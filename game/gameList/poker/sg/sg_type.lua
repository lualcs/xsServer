...
---@param b pkCard @牌
---@return boolean
function sg_type:isDuiZi(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
    if hlp:sgColor(a) == hlp:sgColor(b) then
...
---@param b pkCard @牌
---@return boolean
function sg_type:isTianGang(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
    if 0x0c == a or 0x2c == b then
...
---@param b pkCard @牌
---@return boolean
function sg_type:isTianGuan9(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
    if 0x0c == a or 0x2c == b then
...
---@param b pkCard @牌
---@return boolean
function sg_type:isDiGuan9(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
    if 0x02 == a or 0x22 == b then
...
---@param b pkCard @牌
---@return boolean
function sg_type:isRenPai9(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
...
---@param b pkCard @牌
---@return boolean
function sg_type:isChangEr9(a,b)
    ---帮助
    ---@type sg_helper
    local hlp = self._hlp
