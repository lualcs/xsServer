...
---@return number
function logic:getJoinWildDouble(axles,icon,wdbles)
...
---随机翻倍
---@param result jjbx_result_normal
function logic:randomDouble(result)
