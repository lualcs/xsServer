...
local dfeng111  = {[0x31]=3,__tostring = function() return "dfeng111" end}      set_mt_tostring(dfeng111)
local nfeng222  = {[0x32]=3,__tostring = function() return "nfeng222" end}      set_mt_tostring(nfeng222)
local xfeng333  = {[0x33]=3,__tostring = function() return "xfeng333" end}      set_mt_tostring(xfeng333)
local bfeng444  = {[0x34]=3,__tostring = function() return "bfeng444" end}      set_mt_tostring(bfeng444)
local hzong111  = {[0x35]=3,__tostring = function() return "hzong111" end}      set_mt_tostring(hzong111)
local facai222  = {[0x36]=3,__tostring = function() return "facai222" end}      set_mt_tostring(facai222)
local baban222  = {[0x37]=3,__tostring = function() return "baban222" end}      set_mt_tostring(baban222)
...
local dnx123    = {[0x31]=1,[0x32]=1,[0x33]=1,__tostring = function() return "dnx123"  end} set_mt_tostring(dnx123)
local zfb123    = {[0x35]=1,[0x36]=1,[0x37]=1,__tostring = function() return "zfb123"  end} set_mt_tostring(zfb123)
...
local xnb234   = {[0x32]=1,[0x33]=1,[0x34]=1,__tostring = function() return "feng234" end} set_mt_tostring(xnb234)
...
local groupMap = {
    ...
    [0x06] = {wan456,wan567,wan678,wan666},
    ...
    [0x16] = {suo456,suo567,suo678,suo666},
    ...
    [0x26] = {ton456,ton567,ton678,ton666},
    [0x27] = {ton567,ton678,ton789,ton777},
    [0x28] = {ton678,ton789,ton888},
    [0x29] = {ton789,ton999},

    --字 乱三风
    [0x31] = {dnx123,dfeng111},
    [0x32] = {dnx123,xnb234,nfeng222},
    [0x33] = {dnx123,xnb234,xfeng333},
    [0x34] = {xnb234,bfeng444},
    [0x35] = {zfb123,hzong111},
    [0x36] = {zfb123,facai222},
    [0x37] = {zfb123,baban222},
}
