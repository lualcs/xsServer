...
---坎斗
---@return boolean
function bullAlgor:setSupportTriplet(support)
...
---坎斗
---@return boolean
function bullAlgor:getSupportTriplet()
    return self._bfTriplet
end

---顺斗
---@return boolean
function bullAlgor:getSupportStraight()
...
---@return bullMethod
function bullAlgor:getMethod(hands,repe)
    ---癞子
    ---@type pkCard[]
...
function bullAlgor:getBullCount(hands)
    ---帮助
    ---@type bullHelper
    local hp = self._hlp
    ---坎斗
